...
var icwsDirectUsageExample = (function (applicationExports) {
    ...
    //
    // ICWS session namespace.
    //
    // This provides an abstraction around the ICWS connection, request, and message processing mechanisms.
    //
    applicationExports.session = (function (exports) {
        //
        // Credential storage
        //
        ...
        */
        ...
        exports.icwsConnect = function (application, server, user, password, connectCallback, opt_disconnectCallback) {
            ...
            diagnostics.reportInformationalMessage('Connect to ICWS', 'Establish a connection to the ICWS server.');
        ...
        exports.icwsDisconnect = function () {
            ...
            if (exports.isConnected()) {
                diagnostics.reportInformationalMessage('Disconnect from ICWS', 'Close the connection to the ICWS server.');
        ...
        */
        ...
        function sendRequestImpl(server, method, requestPath, payload, resultCallback, opt_excludeSessionId) {
            ...
            // Support application diagnostic display.
            diagnosticValue = payload;
            ...
            diagnostics.reportRequestResponse('Sent request', method, correlationId, uri, diagnosticValue);
        ...
        function sendRequestCompleted(xmlHttp, sessionId, correlationId, resultCallback) {
            ...
            // Support application diagnostic display.
            diagnostics.reportRequestResponse('Received response', status, correlationId, null, diagnosticResponseValue);
            
            console.log(diagnosticResponseValue);
        ...
        function messageProcessingTimerCallback() {
            ...
            diagnostics.reportInformationalMessage('Retrieve messages from ICWS', 'Retrieve any pending event messages from the ICWS server.');
            ...
            exports.sendRequest('GET', '/messaging/messages', payload, function (status, jsonResponse, correlationId, sessionId) {
                ...
                if (currentSessionId === sessionId) {
                    if (utilities.isSuccessStatus(status)) {
                        ...
                        console.warn('Get response: ' + jsonResponse);
        ...
        function processMessage(jsonMessage) {
            ...
            // console.warn('Process message: ' + JSON.parse(jsonMessage));
